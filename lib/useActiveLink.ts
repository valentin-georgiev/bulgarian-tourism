...
const activeStyles: Record<LinkVariant, string> = {
  navbar: "text-green-700 dark:text-green-400 font-semibold transition-colors",
  mobile:
  ...
  footer: "text-green-700 dark:text-green-400 font-semibold transition-colors",
};

const inactiveStyles: Record<LinkVariant, string> = {
  navbar: "hover:text-green-700 dark:hover:text-green-400 transition-colors",
  mobile:
  ...
  footer: "hover:text-green-700 dark:hover:text-green-400 transition-colors",
};
