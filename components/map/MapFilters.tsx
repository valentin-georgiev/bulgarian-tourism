...
export default function MapFilters({
  ...
  return (
    <div className="absolute top-4 left-4 z-[1000] flex flex-col gap-2 max-w-[calc(100%-2rem)] sm:max-w-md">
      <div className="flex flex-wrap gap-1.5 bg-white/90 backdrop-blur-sm rounded-xl p-2 shadow-lg border border-gray-200">
        {/* All toggle */}
        <button
          onClick={onToggleAll}
      ...
      {/* Places count badge */}
      <span className="self-start bg-white/90 backdrop-blur-sm text-xs text-gray-600 px-3 py-1 rounded-full shadow border border-gray-200">
